...
**Terminal vs Kaggle commands:** command examples below are shown in terminal style (`python ...`). In Kaggle, run the same commands prefixed with `!` and include the folder path, e.g. `!python spotify-ml/scripts/train_mood_classifier.py`.
